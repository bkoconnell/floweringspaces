...
const flowersUpdateFlower = async (req, res) => {
    console.log('Verifying user authorization for flowersUpdateFlower() method...');
    // REQUIRES AUTHORIZATION -- call getUser() method
    getUser(req, res,
        (req, res) => {
...
const flowersDeleteFlower = async (req, res) => {
    console.log('Verifying user authorization for flowersDeleteFlower() method...');
    // REQUIRES AUTHORIZATION -- call getUser() method
    getUser(req, res,
        (req, res) => {
            // destructure assignment to extract request parameter 'flowerCode'
...
const getUser = (req, res, callback) => {
    console.log('Inside getUser() method... please wait while user access is verified...');
